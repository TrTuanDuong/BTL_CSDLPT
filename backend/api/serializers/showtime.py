...
class ShowtimeSerializer(serializers.ModelSerializer):
    ...
    movie_duration = serializers.IntegerField(source='movie.duration_min', read_only=True)
    ...
    class Meta:
        model = Showtime
        fields = ['id', 'movie', 'movie_title', 'movie_duration', 'auditorium', 
                 'auditorium_name', 'start_time', 'end_time', 'base_price', 
...
class ShowtimeCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        end_time = start_time + timedelta(minutes=movie.duration_min + 30)  # +30 phút dọn dẹp
...
class ShowtimeDetailSerializer(ShowtimeSerializer):
    ...
    class Meta(ShowtimeSerializer.Meta):
        fields = ShowtimeSerializer.Meta.fields + ['movie_info', 'auditorium_info', 'seat_pricing']
